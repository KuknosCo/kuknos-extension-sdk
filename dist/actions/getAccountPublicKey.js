...
export function getAccountPublicKey() {
    return new Promise(function (resolve, reject) {
        var confirmWin = window.open(baseUrl + "/intent/account-publickey", "myWindow", "width=" + windowConfig.width + ",height=" + windowConfig.height + ",top=" + windowConfig.top + ",left=" + windowConfig.left + ",scrollbars=no");
